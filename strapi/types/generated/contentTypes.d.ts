...
export interface ApiUserSchemaUserSchema extends Struct.CollectionTypeSchema {
  collectionName: 'user_schemas';
  info: {
    displayName: 'userSchema';
    pluralName: 'user-schemas';
    singularName: 'user-schema';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-schema.user-schema': ApiUserSchemaUserSchema;
